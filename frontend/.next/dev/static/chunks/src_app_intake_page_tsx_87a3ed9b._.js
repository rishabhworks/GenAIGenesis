...
;
;
/* ─── Waveform visualizer ─── */ // Tries Web Audio API first; falls back to a sine-wave simulation
// so it doesn't conflict with SpeechRecognition's mic grab.
function WaveformVisualizer({ active }) {
    _s();
    const [bars, setBars] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Array(28).fill(0.05));
        ...
        "WaveformVisualizer.useEffect": ()=>{
            ...
            if (!active) {
                ...
                if (streamRef.current) streamRef.current.getTracks().forEach({
                    "WaveformVisualizer.useEffect": (t)=>t.stop()
                }["WaveformVisualizer.useEffect"]);
            ...
            function runSimulated() {
                let t = 0;
                const tick = {
                    "WaveformVisualizer.useEffect.runSimulated.tick": ()=>{
                        if (!mountedRef.current) return;
                        t += 0.07;
                        setBars(Array.from({
                            length: 28
                        }, {
                            "WaveformVisualizer.useEffect.runSimulated.tick": (_, i)=>{
                                const v = Math.sin(t + i * 0.45) * 0.28 + Math.sin(t * 1.7 + i * 0.3) * 0.18 + Math.random() * 0.12 + 0.18;
            ...
            if (navigator.mediaDevices?.getUserMedia) {
                navigator.mediaDevices.getUserMedia({
                    ...
                    "WaveformVisualizer.useEffect": (stream)=>{
                        ...
                        const BAR = 28;
                        const tick = {
                            "WaveformVisualizer.useEffect.tick": ()=>{
                                if (!mountedRef.current) return;
                                analyser.getByteFrequencyData(data);
                                setBars(Array.from({
                                    length: BAR
                                }, {
                                    "WaveformVisualizer.useEffect.tick": (_, i)=>{
                ...
                }["WaveformVisualizer.useEffect"]).catch({
                    "WaveformVisualizer.useEffect": ()=>runSimulated()
                }["WaveformVisualizer.useEffect"]);
            } else {
                runSimulated();
            }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex items-end justify-center gap-[3px] h-10 my-3",
...
_s(WaveformVisualizer, "ztw/OL2HsaEfmupErwtJjKP52p0=");
...
function IntakePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IntakePage.useEffect": ()=>{
            ...
            rec.lang = 'en-US';
            rec.onresult = ({
                "IntakePage.useEffect": (event)=>{
                    const result = event.results[event.results.length - 1];
                    setTranscript(result[0].transcript);
                }
            })["IntakePage.useEffect"];
            rec.onend = ({
                "IntakePage.useEffect": ()=>setListening(false)
            })["IntakePage.useEffect"];
            rec.start();
            return ({
                "IntakePage.useEffect": ()=>rec.abort()
            })["IntakePage.useEffect"];
        }
    }["IntakePage.useEffect"], [
        listening
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full h-0.5 bg-[#1E1E2E]",
                        ...
                        children: !done ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-[#52525B] text-sm mb-3 tracking-wide uppercase font-medium",
                                    children: [
                                        "Question ",
                                        current + 1
                                    ]
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                                            ...
                                            className: `relative w-24 h-24 rounded-full flex items-center justify-center transition-all duration-300 ${listening ? 'bg-[#F97316] shadow-[0_0_40px_rgba(249,115,22,0.4)]' : 'bg-[#111118] border-2 border-[#1E1E2E] hover:border-[#F97316]/50'}`,
                                            children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(WaveformVisualizer, {
                                                active: listening
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/intake/page.tsx",
                                                lineNumber: 257,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-[#52525B] text-sm",
                                            children: listening ? 'Listening... tap to stop' : 'Tap to speak'
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/intake/page.tsx",
                                            lineNumber: 260,
                                            columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "bg-[#111118] border border-[#1E1E2E] rounded-2xl p-5 mb-6 min-h-[80px] flex items-center transition-all duration-200",
                                    children: transcript ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        className: "text-[#52525B] text-sm",
                                        children: questions[current].placeholder
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/intake/page.tsx",
                                        lineNumber: 270,
                                        columnNumber: 21
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Building your WiseHire profile..."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/intake/page.tsx",
                                    lineNumber: 308,
                                    columnNumber: 17
...
_s1(IntakePage, "2GVJ0mhS5fppBw42QQ9JqUzDeyE=", false, function() {
    return [
...
//# sourceMappingURL=src_app_intake_page_tsx_87a3ed9b._.js.map